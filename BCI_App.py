"""Entry point BCI — root level para que Streamlit detecte pages/ correctamente."""
import os
import streamlit as st
from utils import render_dashboard

st.set_page_config(
    page_title="BCI · Relif",
    page_icon="https://raw.githubusercontent.com/manuelbunster-commits/relif-dashboard/main/bci_logo.png",
    layout="wide",
)
